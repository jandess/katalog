    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 pb-28 md:pb-12 max-w-5xl mx-auto items-start">
      <div class="relative rounded-3xl overflow-hidden shadow-2xl md:sticky md:top-24">
        <div class="relative aspect-[4/5] md:aspect-square bg-white" id="image-slider">
          ...
          <div id="product-img-counter" class="absolute top-3 right-3 bg-black/50 backdrop-blur-sm text-white text-xs font-bold px-2.5 py-1 rounded-full pointer-events-none">1 / ${images.length}</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
      <div class="relative rounded-3xl overflow-hidden shadow-2xl md:sticky md:top-24">
        <div class="relative aspect-[4/5] md:aspect-square bg-white" id="box-image-slider">
          ...
          <!-- Counter badge kanan atas -->
          <div id="box-img-counter" class="absolute top-3 right-3 bg-black/50 backdrop-blur-sm text-white text-xs font-bold px-2.5 py-1 rounded-full pointer-events-none">1 / ${variantImages.length}</div>
          <!-- Dot indicators bawah -->
          <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-black/40 backdrop-blur-sm px-3 py-1.5 rounded-full">
